    ...
    <div className="w-full h-fit px-4 md:px-10 shadow-md sticky top-0 z-50 bg-[#ECE7CA] text-[#5A4B35]">
      ...
      <div className="h-20 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="hidden lg:flex items-center gap-6 text-md font-medium">
            <Link to="/" className="hover:text-[#C8AD7E] transition">Home</Link>
            <Link to="/about" className="hover:text-[#C8AD7E] transition">About</Link>
            <Link to="/category" className="hover:text-[#C8AD7E] transition">Category</Link>
            <Link to="/shop" className="hover:text-[#C8AD7E] transition">Shop</Link>
            <Link to="/contact" className="hover:text-[#C8AD7E] transition">Contact</Link>
          </div>
          ...
          <Link to="/profile"><CgProfile className="cursor-pointer hover:text-[#C8AD7E] text-xl" /></Link>
      ...
      {menuOpen && (
        <div className="absolute right-4 top-20 flex flex-col gap-3 z-40">
          ...
          <Link to="/" className="dropCard fade delay-1 flex items-center gap-2"><MdHome /> Home</Link>
          <Link to="/about" className="dropCard fade delay-2 flex items-center gap-2"><MdInfo /> About</Link>
          <Link to="/category" className="dropCard fade delay-3 flex items-center gap-2"><MdCategory /> Category</Link>
          <Link to="/shop" className="dropCard fade delay-4 flex items-center gap-2"><RiShoppingBag3Line /> Shop</Link>
          <Link to="/contact" className="dropCard fade delay-5 flex items-center gap-2"><MdContactMail /> Contact</Link>
